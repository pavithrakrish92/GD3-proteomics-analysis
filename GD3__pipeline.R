# ==============================================================================
# GD3 Biomarker Paper - Full Figure Generation Pipeline
#
# Consolidates and completes the analysis from:
#   - GD3 data analysis v4_Claude version.R
#   - GD3 data analysis v4.R
#   - GD3 analysis for Plasma and CSF_FINAL_Paper.R
#
# Produces every panel referenced in the Figure Legends of
# "GD3 biomarkers paper vF-4 - post amprion.docx" (Figures 1-3).
# Figure 4 (seed amplification assay + published PD biomarker panel) is NOT
# proteomics/OLINK data and is only stubbed out at the bottom - see the note
# there before you run that section.
#
# NOT executed or verified against the real data by the assistant that wrote
# this (no R installation / data files were available in the review
# environment). Run it yourself and visually compare the outputs in
# "TIFF Images/" (this script overwrites them in place) against the
# manuscript before relying on it.
# ==============================================================================
...
# ==============================================================================
# 0. PATHS - EDIT THESE to match your data location
# ==============================================================================
# All three source scripts pointed at "Training/Training/GD3 data analysis v2/...",
# which does not exist under this project folder. The matching files were found
# under Z:\K\KRISHNASWAMI.Pavithra\RND\GD3\Data analysis for GD3 paper\Metadata
# and Olink parquet files\. Update these four paths if that's not where your
# copies live.

path_metadata_plasma <- "../Data analysis for GD3 paper/Metadata and Olink parquet files/Metadata_plasma_1.xlsx"
path_npx_plasma      <- "../Data analysis for GD3 paper/Metadata and Olink parquet files/GD3_Plasma_NPX.parquet"
path_metadata_csf    <- "../Data analysis for GD3 paper/Metadata and Olink parquet files/Metadata_CSF.xlsx"   # CONFIRM this file name/location
path_npx_csf         <- "../GD3 CSF/Explore HT/Metadata and results/AMETHIST__Venglustat_CSF_NPX_2024-03-13.parquet"

output_dir <- "TIFF Images"

# ==============================================================================
# 1. LOAD + MERGE DATA
# ==============================================================================

Metadata_plasma <- read_excel(path_metadata_plasma)
OLINKdata_Plasma <- read_parquet(path_npx_plasma)
Metadata_CSF <- read_excel(path_metadata_csf)
OLINKdata_CSF <- read_parquet(path_npx_csf)
